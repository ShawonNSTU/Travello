...
public class ViewPostFragment extends Fragment {
    ...
    private UserPersonalInfo mCurrentUser;
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot singleSnapshot : dataSnapshot.getChildren()){
                    ...
                    DatabaseReference reference = FirebaseDatabase.getInstance().getReference();
                    Query query = reference
                            .child(getString(R.string.user_personal_Info))
                    ...
                    query.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            for(DataSnapshot singleSnapshot : dataSnapshot.getChildren()){
                                ...
                                mUsers.append(singleSnapshot.getValue(UserPersonalInfo.class).getUsername());
                                mUsers.append(",");
                            }
    ...
    private void getCurrentUser(){
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for ( DataSnapshot singleSnapshot :  dataSnapshot.getChildren()){
                    mCurrentUser = singleSnapshot.getValue(UserPersonalInfo.class);
                }
                getLikesString();
            }
    ...
    private void getPhotoDetails(){
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for ( DataSnapshot singleSnapshot :  dataSnapshot.getChildren()){
                    mUserPublicInfo = singleSnapshot.getValue(UserPublicInfo.class);
                }
            }
    ...
    private String getTimestampDifference(){
        ...
        sdf.format(today);
        Date timestamp;
        final String photoTimestamp = mPhoto.getUploaded_date();
        try{
